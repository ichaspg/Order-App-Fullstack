              ...
              <div className='order-detail' key={selectedOrder._id}>
                  ...
                  {selectedOrder.order.item.map((item) => (
                    <div className="order-detail-list" key={item._id}>
                      ...
                      <div className="product-detail">
                        ...
                        <p className="item-price">{formatRupiah(item.totalPrice)}</p>
                      </div>
                    </div>
                  ))}
                </div>
                <div className="dicount-cont">
                  <input type="number" id='discount' min='0' max='99' maxLength='2' onChange={handleChange} /> %
                </div>
                ...
                <div className="price-detail-cashier">
                  <div className="subtotal-detail">
                    <p>Subtotal</p>
                    <p>{formatRupiah(selectedOrder.subtotal)}</p>
                  </div>
                  <div className="tax-detail">
                    <p>Tax (10%)</p>
                    <p>{formatRupiah(selectedOrder.subtotal * 0.1)}</p>
                  </div>
                  <div className="tax-detail">
                    <p>Discount {discount}% : </p>
                    <p>{formatRupiah(selectedOrder.total * (discount * 0.01))}</p>
                  </div>
                  <div className="total-detail">
                    <p>Total</p>
                    <p>{formatRupiah(selectedOrder.total - (selectedOrder.total * (discount * 0.01)))}</p>
                  </div>
                </div>
